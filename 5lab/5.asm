; Вариант 18
; Разрядность слова некоторого гипотетического процессора - 22 бита. 
; Слова могут  принимать  положительные  или  отрицательные  значения.  Отрицательные значения хранятся в дополнительном коде.
; Объект моделирования:  массив N-разрядных слов из 16 элементов. Элементы располагаются в памяти реальной машины без промежутков.
; Макроопределения:
